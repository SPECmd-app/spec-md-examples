...
In scope: the homepage, the standard's own versioned documents, worked examples, agent-integration files, companion-tooling coverage, version links, machine-readable discovery files, and the changelog, and consent-gated visitor analytics.
